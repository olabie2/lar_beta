    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            @foreach($services as $index => $service)
                <div class="scroll-reveal delay-{{ $index + 1 }} group relative bg-gradient-to-br from-indigo-900/40 to-purple-900/40 backdrop-blur-sm border border-indigo-500/30 rounded-3xl p-6 sm:p-8 hover:scale-105 hover:border-indigo-400/60 transition-all duration-500 hover:shadow-2xl hover:shadow-indigo-500/20">
                    <h3 class="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4 mt-2 sm:mt-4">{{ __("messages.home.services.{$service['key']}.title") }}</h3>
